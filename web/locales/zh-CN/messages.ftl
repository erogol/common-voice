...
contribution-misreadings-example-1-title = 三叠纪的巨型恐龙。
contribution-misreadings-example-2-title = 三叠纪的巨型恐尤。
contribution-misreadings-example-2-explanation = [应该是“恐龙”]
contribution-misreadings-example-3-title = 三叠纪的巨型恐。
contribution-misreadings-example-3-explanation = [录音在最后一个词结束前终止]
contribution-misreadings-example-4-title = 三叠纪的巨型恐龙。是的。
contribution-misreadings-example-4-explanation = [所录内容多于要求文本]
contribution-misreadings-example-5-title = 我们要出去喝咖啡。
contribution-background-noise-title = 背景噪音
contribution-background-noise-example-1-fixed-title = <strong>[喷嚏]</strong> 三叠纪的 </strong>[咳嗽]</strong> 巨型恐龙。
