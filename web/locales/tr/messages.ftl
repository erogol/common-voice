...
contribution-criteria-page-description = Ses kayıtlarını dinlerken nelere dikkat etmeniz gerektiğini anlayıp ses kayıtlarınızı daha da zenginleştirmeye yardımcı olun!
contribution-for-example = örnek
contribution-misreadings-title = Yanlış okumalar
contribution-misreadings-description = Dinlerken, kaydedilen seslerin yazılanlarla tam olarak aynı olup olmadığını çok dikkatli bir şekilde kontrol edin; küçük hatalar olsa bile reddedin. <br />Şunlar çok yaygın yapılan hatalardır:
contribution-misreadings-description-extended-list-5 = Bir kelimeyi okumak için birkaç deneme yapmak.
contribution-background-noise-title = Arka plan gürültüsü
contribution-background-noise-example-2-explanation = [Metnin bir kısmı duyulmuyor]
contribution-background-voices-title = Arka plan sesleri
contribution-background-voices-example-1-explanation = Geliyor musun? <strong>[başka birinin sesi]</strong>
