...
contribution-misreadings-description-extended-list-1 = Okañy <strong>'A'</strong> térã <strong>'The'</strong> ñeñongatu oñepyrũvo.
...
contribution-background-voices-example-1-explanation = ¿Ejúta? <strong>[ambue ohenóiva]</strong>
contribution-volume-title = Mbopuha
contribution-just-unsure-title = ¿Nahekorosãi?
