...
ready-to-record = Готові допомогти записом свого голосу?
all-locales = Усі
today = Сьогодні
x-weeks-short =
    { $count ->
...
why-profile-text = Надаючи деякі відомості про себе, звукові дані, які ви надсилаєте до Common Voice, будуть корисніші для систем розпізнавання мови, що застосовують ці дані для вдосконалення їхньої точності.
dashboard = Панель
...
skip-submission-feedback = Пропускати підтвердження надсилання
...
clips-uploaded = Записи надіслано
...
visibility-explainer = Цей параметр контролює видимість таблиці лідерів. Коли сховано, то ваш прогрес буде приватним. Це означає, що ваше зображення, ім’я користувача та прогрес не буде показано в таблиці лідерів. Зауважте, що для оновлення таблиці лідерів потрібно ~{ $minutes } хв., щоб застосувати зміни.
