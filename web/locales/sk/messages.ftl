...
resource-nemo-info = <githubLink>NVIDIA NeMo</githubLink> ™ je <docsLink>open-source sada nástrojov</docsLink> pre výskumníkov, ktorí vyvíjajú najmodernejšie konverzačné modely AI.
resource-deepspeech-info = Open source engine rozpoznávania hlasu spoločnosti Mozilla Deep Speech je možné použiť na vytváranie aplikácií na rozpoznávanie reči. Prečítajte si náš <githubLink>prehľad Githube</githubLink> alebo sa pripojte k diskusnému fóru <discourseLink>DeepSpeech Discourse</discourseLink>, kde sa dozviete, ako začať.
resource-coqui-info = <coquiLink>Coqui</coquiLink> sa zaoberá technológiou otvorenej reči. Ich projekty zahŕňajú enginy STT a TTS založené na hlbokom učení.
community-playbook = Komunitná príručka
resource-playbook-info = <playbookLink>Pozrite si užitočné návody</playbookLink> týkajúce sa Common Voice, od lokalizácie po používanie množiny údajov, ako aj k spojeniu s našou komunitou.
...
contribution-misreadings-example-8-title = Uháňajúci čmeliak.
...
contribution-background-noise-example-2-fixed-title = Obrovský dino <strong>[zakašľanie]</strong> trias.
