...
return-to-cv = Велявтомс мекев «Common Voice» сайтс
email-input =
    .label = ёндолсёрма
submit-form-action = Кучомс
loading = Тарги...
...
indicates-required = * пештемань туртов чаво таркат.
...
show-wall-of-text = Пакшонь-пакш
help-us-title = Лездак миненек кочкамс вадря валрисьметь!
help-us-explain = Лепштик  «кунсоломс» повненть, кунсолок ды ёвтак тенек: ало максозь рисьмесь видестэ ёвтазь?
...
shortcut-submit-label = Кучомс роликть
...
max-file-size = весемеде ламо { $kb }kb
...
contribution-background-noise-example-1-fixed-title = Триас <strong>[Sneeze]</strong> пингень покштояк покш <strong>[cough]</strong> инеметьказт.
